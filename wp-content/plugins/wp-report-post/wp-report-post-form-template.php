...
<div class="wp-report-post-box">
    ...
    <form method="post" id="wp-report-post-form" class="wp-report-post-form">
        ...
        <div class="wp-report-post-row">
            <div>
                <label for="wp-report-post-message"><?php _e("Veuillez nous indiquer les raisons de ce signalement ?"); ?> <span class="required">*</span></label>
        ...
        <div class="wp-report-post-form-left">
            <a class="wp-report-post-button" id="wp-report-post-submit"><?php _e("Envoyer signalement"); ?></a>
        </div>
